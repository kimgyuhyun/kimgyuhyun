...
### 📌 About Me
- 반복되는 로직은 함수 단위로 분리해 재사용성과 가독성을 높이려 합니다.
...
#### Testing & API Tools
<img src="https://img.shields.io/badge/Postman-FF6C37?style=for-the-badge&logo=postman&logoColor=white"> <img src="https://img.shields.io/badge/JUnit-25A162?style=for-the-badge&logo=junit5&logoColor=white">
...
### 🛠 Personal Projects
- 애니 OTT 서비스
  - 역할: 개인 프로젝트(백/프론트 전반적으로 기획 및 설계, CI/CD 파이프라인 구축 및 배포 자동화)
...
- LOL 전적 사이트
  - 역할: 개인 프로젝트(백/프론트 전반적으로 기획 및 설계, CI/CD 파이프라인 구축 및 배포 자동화)
  - 기간: 2026.04.16 ~ 2026.06.30
  - 목표: 리그오브레전드 전적 검색/통계 서비스
  - 링크: [Github](https://github.com/kimgyuhyun/record_site)
  - Live: [KDA.GG](https://kdagg.kozow.com/)
